...
/**
 * <p>Clase Java para encontrarFormaPagoPorIdResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="encontrarFormaPagoPorIdResponse">
 *   &lt;complexContent>
...
@XmlType(name = "encontrarFormaPagoPorIdResponse", propOrder = {
    "_return"
})
public class EncontrarFormaPagoPorIdResponse {
